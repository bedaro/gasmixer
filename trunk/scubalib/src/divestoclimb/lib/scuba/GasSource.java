...
public interface GasSource {
	 ...
	 */
	abstract public double pO2AtDepth(int depth, Units units);
	 ...
	 */
	abstract public double pN2AtDepth(int depth, Units units);
	 ...
	 */
	abstract public double pHeAtDepth(int depth, Units units);
